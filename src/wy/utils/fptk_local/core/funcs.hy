...
; Import (required for functions def) ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    ;; wy.utils.fptk_local functions require in their code:
    ;; - of, comment
    ;; - List
...
; [MACRO] Reimported macros ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (require wy.utils.fptk_local.core.macros [
        ...
        pluckm              #_ "[GROUP] Getters: keys and attrs | (pluckm n xs) (pluckm key ys) (pluckm .attr zs) | accepts wy.utils.fptk_local-style .arg syntax"
        lpluckm             #_ "[GROUP] Getters: keys and attrs | | list version of pluckm"
        getattrm            #_ "[GROUP] Getters: keys and attrs | (getattrm Object 'attr') (getattrm Object .attr) | accepts wy.utils.fptk_local-style .attr syntax"
