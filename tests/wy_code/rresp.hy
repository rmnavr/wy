...
; [F] PCH_Cards to PDataDF ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn #^ PDataDF; for one entry
        ...
        (entry.rawDF.select
            [ (. (pl.col DFH_Raw.F) (alias DFH_PData.f))
...
; [F] build plot ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\ {{{1
    ...
    (defn #^ P9Plot
        ...
        (+ (p9.ggplot df)
            ...
            (p9.geom_line)
            (p9.scale_x_log10 :limits [100 2000]
                             :expand [0 0]
                             :breaks (lrange_ 100 2000 100)
                             :labels [#* (lrange_ 100 900 100) #* ["1k" "" "" "" "" "1.5k" "" "" "" "" "2k"]])
            (p9.scale_y_log10 :limits [0.0001 1000]
                             :expand [0 0]
                             :breaks [0.0001 0.001 0.01 0.1 1 10 100 1000]
...
; _____________________________________________________________________________/ }}}1
    ...
    ;setv $FILENAME "V:/Electric Propulsion/Averyanov_CalcNode/z_result.pch"
